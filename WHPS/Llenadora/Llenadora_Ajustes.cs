...
{
    public partial class Llenadora_Ajustes : Form
    {
        string password = "";
        string campokeyboard = "";

        public Llenadora_Ajustes()
        {
            InitializeComponent();
        }
        ...
        private void Llenadora_Ajustes_Load(object sender, EventArgs e)
        {
        ...
        private void CV_Tol1_Menor1LTB_MouseClick(object sender, MouseEventArgs e)
        {

        }

        private void CV_Tol2_Menor1LTB_MouseClick(object sender, MouseEventArgs e)
        {

        }

        private void CV_Tol1_Mayor1LTB_MouseClick(object sender, MouseEventArgs e)
        {

        }

        private void CV_Tol2_Mayor1LTB_MouseClick(object sender, MouseEventArgs e)
        {
