...
{
    public partial class Administracion_Carga : Form
    {
        public Administracion_Carga()
        {
            InitializeComponent();
        }

        private void Administracion_Carga_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            ...
            MainAdministracion_Calidad.estadobusqueda = false;
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if ((progressBar1.Value == 100) & (progressBar2.Value == 100) & (progressBar3.Value == 100) & (progressBar4.Value == 100))
            {
                ...
                Close();
                MainAdministracion_Calidad.estadobusqueda = true;
