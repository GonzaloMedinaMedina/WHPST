...
namespace WHPS.Etiquetadora
{
    public partial class Etiquetadora_Comentarios : Form
    {
        ...
        private void Etiquetadora_Comentarios_Load(object sender, EventArgs e)
        {
        ...
        private void saveBot_Click(object sender, EventArgs e)
        {
            ...
            {
                string salida = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileEtiquetadora, "Comentarios", listavalores, "Id");
