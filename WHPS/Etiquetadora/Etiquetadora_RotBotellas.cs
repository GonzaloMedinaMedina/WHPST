...
{
    public partial class Etiquetadora_RotBotellas : Form
    {
        //Variables del form
        string botrotas;
        ...
        /// </summary>
        private void Etiquetadora_RotBotellas_Load(object sender, EventArgs e)
        {
        ...
        private void saveBot_Click(object sender, EventArgs e)
        {
            if ((MaquinaLinea.Password == true && numrotasTB.Text != "") || botrotas == "NO")
            {
                ...
                string salida = MaquinaLinea.GuardarFormRoturaBotellas("Etiquetadora", MaquinaLinea.MEtiquetadora, botrotas, numrotasTB.Text, limpieza_area, limpieza_trab, "Etiquetadora");
