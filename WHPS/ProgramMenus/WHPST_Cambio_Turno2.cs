...
{
    public partial class WHPST_Cambio_Turno2 : Form
    {
        public string Turno = "";
        public string Puntero = "";
        public bool cambio = false;
        public WHPST_Cambio_Turno2()
        {
            InitializeComponent();
        }

        //Cagarmos los datos conocidos
        private void WHPST_Cambio_Turno2_Load(object sender, EventArgs e)
        {
        ...
        private void respTB_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            WHPST_Cambio_Turno2.ActiveForm.Activate();
            respTB.Select();
            cambio = true;
        }
