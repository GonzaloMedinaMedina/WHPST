...
{
    public partial class Produccion_L2 : Form
    {
        public string DIA1;
        public string DIA2;
        public string DIA3;
        ...
        public Produccion_L2()
        {
            InitializeComponent();
        }


        private void Produccion_L2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                dataGridViewRegistroEnc.DataSource = Datos_Produccion.EncajonadoraL2.Tables[Datos_Produccion.FEncL2[1, 0]];
            ...
            for (int j = 0; j < 5; j++)
            {
                ...
                chart1.Series["LINEA 2"].Points.AddXY(j, Botellas);
                chart1.Series["OBJETIVO"].Points.AddXY(j, MaquinaLinea.OBJETIVOL2);
                DatosFinales[j] = Botellas;
                k++;
            }
            MaquinaLinea.DatosTotalesL2 = DatosFinales;
        }
