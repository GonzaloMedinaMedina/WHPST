...
{
    public partial class Produccion_L5 : Form
    {
        public string DIA1;
        public string DIA2;
        public string DIA3;
        ...
        public Produccion_L5()
        {
            InitializeComponent();
        }


        private void Produccion_L5_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                dataGridViewRegistroEnc.DataSource = Datos_Produccion.EncajonadoraL5.Tables[Datos_Produccion.FEncL5[1, 0]];
            }
            catch (Exception ex)
            {
            ...
            for (int j = 0; j < 5; j++)
            {
                ...
                chart1.Series["LINEA 5"].Points.AddXY(j, Botellas);
                chart1.Series["OBJETIVO"].Points.AddXY(j, MaquinaLinea.OBJETIVOL5);
                DatosFinales[j] = Botellas;
                k++;
            }
            MaquinaLinea.DatosTotalesL5 = DatosFinales;
        }
