    ...
    public partial class Despaletizador_RotBotellas : Form
    {
        ...
        private void saveBot_Click(object sender, EventArgs e)
        {
            if ((MaquinaLinea.Password == true && numrotasTB.Text !="") || botrotas == "NO")
            {
                ...
                string salida = MaquinaLinea.GuardarFormRoturaBotellas("Despaletizador", MaquinaLinea.MDespaletizador, botrotas, numrotasTB.Text, limpieza_area, limpieza_trab, "Despaletizador");
