...
{
    public partial class Rotura_Llen : Form
    {
        ...
        private void Rotura_Llen_Load(object sender, EventArgs e)
        {
            for (int i = 0; i < 3; i++)
            {
                Turno[i] = 0;
            ...
            if (MaquinaLinea.Rotura_Guardar == true)
            {
                ...
                CompletarRoturaLlenadora();
                AvisoCargaLB.Visible = false;
                MaquinaLinea.Rotura_Llen = true;
            }
        }


        public void CompletarRoturaLlenadora()
        {
            for (int i = 0; i < 3; i++)
            {
                Turno[i] = 0;
            ...
            try
            {
                ...
                string salida = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileRotura, "Enjuagadora", listavalores, "Id");
                string salida1 = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileRotura, "Llenadora", listavalores, "Id");
                string salida2 = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileRotura, "TaponadoraRoscadora", listavalores, "Id");
                string salida3 = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileRotura, "Capsuladora", listavalores, "Id");
            }
            catch (Exception ex)
            {
        ...
        public void DatosRotura()
        {
            ...
            try
            {
                ...
                if (ArraySintetizada[6] == "Taponadora/Roscadora") ArraySintetizada[6] = "TaponadoraRoscadora";
                string salida = ExcelUtiles.EscribirFicheroExcel(MaquinaLinea.FileRotura, ArraySintetizada[6], listavalores, "Id");
        ...
        {
            DiaActual = Rotura[0];
            MaquinaActual = Rotura[6];
            if (DiaActual == DiaAnterior && MaquinaActual== MaquinaAnterior)
            {
            ...
            else
            {
                ...
                {
                    ComparadorDia = ArraySintetizada[0];
                    ComparadorMaquina = ArraySintetizada[6];
                    if (ComparadorDia != DiaActual || ComparadorMaquina != MaquinaActual)
                    {
                        EnviaDatos();
                        for (int i = 0; i < 3; i++)
                        {
