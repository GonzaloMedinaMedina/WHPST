...
namespace WHPS.Rotura
{
    class Apps_Rotura
    {
        ...
        public static void Filtros_Des(string[,] filtros)
        {
            ...
            filtros[4, 0] = "Roturas";
            filtros[4, 1] = "FORMAT(Fecha, 'dd/MM/yyyy') as Fecha;Turno;BotRotas;NumAprox;Proveedor;Descripcion;Maquina";
        ...
        public static void Filtros_Llen(string[,] filtros)
        {
            ...
            filtros[4, 1] = "Hora;Barra;Deposito;CodigoProducto;Capacidad;Producto;NBotellas;Graduacion;Inicio;Fin;InicioCambio";
            ...
            filtros[10, 1] = "FORMAT(Fecha, 'dd/MM/yyyy') as Fecha;Turno;BotRotas;NumAprox;Proveedor;Descripcion;Maquina";
        ...
        public static void Filtros_Etiq(string[,] filtros)
        {
            ...
            filtros[5, 0] = "Roturas";
            filtros[5, 1] = "FORMAT(Fecha, 'dd/MM/yyyy') as Fecha;Turno;BotRotas;NumAprox;Proveedor;Descripcion;Maquina";
        ...
        public static void Filtros_Enc(string[,] filtros)
        {
            ...
            filtros[2, 1] = "ParoDesde;ParoHasta;Motivo";
            filtros[3, 0] = "Roturas";
            filtros[3, 1] = "FORMAT(Fecha, 'dd/MM/yyyy') as Fecha;Turno;BotRotas;NumAprox;Proveedor;Descripcion;Maquina";
